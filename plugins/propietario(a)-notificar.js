...
await conn.sendMessage(res, { text: text + ( users == 593993684821 ? '\n\n_atte. MonkeyBot' : '' || users == 593968585383 ? '\n\n_atte. MonkeyBot' : '' || users == 593959425714 ? '\n\n_atte. MonkeyBot' : '' || users == 573238484181 ? '\n\n_atte. MonkeyBot' : '' || users == 584125778026 ? '\n\n_atte. MonkeyBot' : '' || users == 5492266466080 ? '\n\n_atte. MonkeyBot' : '' || users == 50689823726 ? '\n\n_atte. MonkeyBot' : '' || users == 573136855110 ? '\n\n_atte. MonkeyBot' : '' || users == 5217294888993 ? '\n\n_atte. MonkeyBot_' : '' ), mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fkontak })
await delay(3 * 3000)
